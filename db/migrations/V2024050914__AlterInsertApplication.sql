...
BEGIN
    ...
    BEGIN TRY
		...
		SET @invoiceId=(SELECT statusId FROM invoiceStatus WHERE invoiceStatus.status='Pending')
		INSERT INTO invoiceStatusHistory (userId,applicationId,statusId,createdAt)
		VALUES (@email,@applicationId,@invoiceId,GETDATE())
