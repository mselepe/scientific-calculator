...
BEGIN
	...
	DECLARE @locationStatusId INT = (SELECT locationStatusId FROM locationStatuses WHERE statusName = @locationStatus)
BEGIN TRY
BEGIN TRANSACTION;
...
VALUES (@eventId, @userId, @locationId, @locationStatusId)
