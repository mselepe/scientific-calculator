...
BEGIN
    ...
    AND universityDepartments.departmentStatusId = (SELECT departmentStatus.departmentStatusId FROM departmentStatus WHERE departmentStatus.departmentStatus='Active')
