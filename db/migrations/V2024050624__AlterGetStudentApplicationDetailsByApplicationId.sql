...
GROUP BY
    students.studentId, CONCAT(students.name, ' ', students.surname),applicationStatus.status,applicationStatusHistory.statusId, amount, contactNumber, universityApplications.degreeName, students.streetAddress, students.suburb, students.city, students.postalCode, students.idDocumentName, studentApplications.academicTranscriptBlobName, studentApplications.matricCertificateBlobName, studentApplications.financialStatementBlobName, universityApplications.dateOfApplication, email, universities.universityName, faculties.facultyName, students.idNumber, yearOfStudy, universityApplications.applicationId
ORDER BY
    yearOfStudy DESC;
