...
GO
ALTER PROCEDURE [dbo].[UpdateApplicationAmount]
...
BEGIN
    ...
    VALUES
        (@userId, @applicationId, @currentAmount, @newAmount, GETDATE());
    ...
    SELECT 1
        ...
        SELECT MAX(ash2.createdAt)
            ...
            AND ast.status in ('In Review','Approved','Awaiting executive approval', 'Onboarded')
);
