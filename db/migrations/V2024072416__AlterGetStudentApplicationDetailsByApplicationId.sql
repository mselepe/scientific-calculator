...
GROUP BY
    ...
    universityApplications.yearOfFunding, students.idDocumentName, studentApplications.academicTranscriptBlobName,
    ...
    declinedReasonsHistory.reason, declinedReasonsHistory.motivation, expenses.accommodation, expenses.tuition, expenses.meals, expenses.other, expenses.otherDescription, dateOfBirth
ORDER BY
    yearOfStudy DESC;
END