...
IF EXISTS (SELECT * FROM sys.objects 
           WHERE object_id = OBJECT_ID(N'[dbo].[updateDepartmentStatusProc]') 
           AND type IN (N'P', N'PC'))
BEGIN
    DROP PROCEDURE [dbo].[updateDepartmentStatusProc];
END
GO

CREATE PROCEDURE [dbo].[updateDepartmentStatusProc]
