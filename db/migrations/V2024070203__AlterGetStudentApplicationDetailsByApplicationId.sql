...
BEGIN
    ...
    GROUP BY
        ...
        declinedReasonsHistory.reason, declinedReasonsHistory.motivation, expenses.accommodation, expenses.tuition, expenses.meals, expenses.other,expenses.otherDescription
    ORDER BY
        yearOfStudy DESC;
END;