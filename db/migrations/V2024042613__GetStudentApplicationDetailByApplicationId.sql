...
GROUP BY
    students.studentId, CONCAT(students.name, ' ', students.surname), applicationStatusHistory.statusId, amount, contactNumber, universityApplications.degreeName, students.streetAddress, students.suburb, students.city, students.postalCode, universityApplications.dateOfApplication, email, universities.universityName, faculties.facultyName, students.idNumber, yearOfStudy, universityApplications.applicationId
ORDER BY
    yearOfStudy DESC;
